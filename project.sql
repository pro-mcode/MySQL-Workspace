CREATE TABLE employee (
    ...
    sex VARCHAR(1),
    salary INT,
    super_id INT DEFAULT('Undecided'),
    branch_id INT
);
...
SELECT *
from employee
ORDER BY sex, first_name, last_name, salary;
...
SELECT COUNT(emp_id)
FROM employee
WHERE sex = 'M' AND birth_date > '1971-01-01';
...
SELECT COUNT(branch_id), client_name
FROM client
...
SELECT employee.emp_id AS manager_id, employee.first_name AS manager_name, branch.branch_name
FROM employee
JOIN branch
...
--NESTED QUERIES
--Find names of all employess who sold over 30,000 to a sinv=gle client
...
INSERT INTO employee VALUES(109, 'Mart', 'Crane', '1980-02-05', 'F', 58000, 102, 2);
